          ...
          <ModalContent>
            ...
            <ModalBody display={"flex"} flexFlow={"wrap"} gap={3}>
              <FormControl
                ...
                isInvalid={
                  !!(
                    Formik.touched.nodeGroupName && Formik.errors.nodeGroupName
                  )
                }>
                <FormLabel>Node Group Name</FormLabel>
                <Input
                  {...Formik.getFieldProps("nodeGroupName")}
                  placeholder={"Node Group Name"}
                />
                <FormErrorMessage>
                  {Formik.errors.nodeGroupName}
                </FormErrorMessage>
              </FormControl>
              <FormControl
                w={"45%"}
              ...
              <FormControl w={"45%"} my={1}>
                ...
                <Select
                  {...Formik.getFieldProps("instanceTypes")}
              ...
              <FormControl
                ...
                my={1}
                isInvalid={
                  !!(Formik.touched.desiredSize && Formik.errors.desiredSize)
                }>
                <FormLabel>Desired Size</FormLabel>
                <Input
                  {...Formik.getFieldProps("desiredSize")}
                  type={"number"}
              ...
              <FormControl
                ...
                my={1}
                isInvalid={
                  !!(Formik.touched.volumeSize && Formik.errors.volumeSize)
                }>
              ...
              <FormControl
                ...
                <Select
                  ...
                  <option value="resolve:ssm:/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2">
