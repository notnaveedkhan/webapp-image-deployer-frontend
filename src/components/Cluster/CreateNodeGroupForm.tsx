                    ...
                    <ModalContent>
                        ...
                        <ModalBody display={"flex"} flexFlow={"wrap"} gap={3}>
                            <FormControl w={"45%"} my={1}
                                         isInvalid={!!(Formik.touched.nodeGroupName && (Formik.errors.nodeGroupName))}>
                            ...
                            <FormControl w={"45%"} my={1}
                                ...
                                <Select name={"controlPlane"} onChange={handleChangeControlPlane}
                                        onBlur={Formik.handleBlur} placeholder='Control Plane'>
                                    {
                                        controlPlane.map((controlPlane: any) => {
                                            return <option key={controlPlane.id}
                                                           value={controlPlane.id}>{controlPlane.name}</option>
                                        })
                                    }
                            ...
                            <FormControl w={"45%"} my={1}
                                         isInvalid={!!(Formik.touched.maxSize && (Formik.errors.maxSize))}>
                            ...
                            <FormControl w={"45%"} my={1}
                                         isInvalid={!!(Formik.touched.minSize && (Formik.errors.minSize))}>
                            ...
                            <FormControl w={"45%"} my={1}
                                         isInvalid={!!(Formik.touched.desiredSize && (Formik.errors.desiredSize))}>
                                <FormLabel>Desired Size</FormLabel>
                                <Input {...Formik.getFieldProps('desiredSize')} type={'number'}
                                       placeholder={'Desired Size'}/>
                                <FormErrorMessage>{Formik.errors.desiredSize}</FormErrorMessage>
                            </FormControl>
                            <FormControl w={"45%"} my={1}
                                         isInvalid={!!(Formik.touched.volumeSize && (Formik.errors.volumeSize))}>
                                <FormLabel>Volume Size</FormLabel>
                                <Input {...Formik.getFieldProps('volumeSize')} type={'number'}
                            ...
                            <FormControl w={"45%"} my={1}
                                ...
                                <Select {...Formik.getFieldProps('imageId')} placeholder='Image ID'>
                                    <option
                                        value='resolve:ssm:/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2'>resolve:ssm:/aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2
                                    </option>
                                </Select>
