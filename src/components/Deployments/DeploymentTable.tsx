    ...
    return (
        <TableContainer mt={"5em"}>
            ...
            <Box display={'flex'} gap={2}>
                ...
                <IconButton onClick={handleRefetch} aria-label="Refresh" icon={<RepeatIcon color={"blueviolet"}/>}
                ...
                <Tbody>
                    {deployment.map((item: any) => {
                        return <Tr key={item.id}>
                            ...
                            <Td>
                                <IconButton icon={<ViewIcon fontSize={"2xl"}/>} colorScheme={'green'} aria-label='View'
                                            border={"none"} variant="link"/>
                                <IconButton icon={<DeleteIcon onClick={() => handleDelete(item.id)} fontSize={"2xl"}/>}
                                            colorScheme={'red'} aria-label='View' border={"none"} variant="link"/>
                            </Td>
                        </Tr>
                    })
                    }
