import { Box, Divider, Heading, Image, Icon } from "@chakra-ui/react";
import {
  FaFacebookSquare,
  FaInstagramSquare,
  FaTwitterSquare,
...
export default function Footer() {
  return (
    <footer className="relative  text-white bg-blue-900 pt-20 pb-10 lg:pt-[120px] lg:pb-20">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <p className="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                  <svg
                    width="8"
                    height="16"
                    viewBox="0 0 8 16"
              ...
              <p className="text-body-color text-base">&copy; 2025 Waidk8</p>
            </div>
          </div>
        </div>
      </div>
