            ...
            <div className="w-[80%] mx-auto my-4">
                <div className="w-full mt-6">
                    <TableContainer className="min-h-[400px]">
                        <Heading className="text-center">Open Reports</Heading>
                        <Table>
                            <Thead>
                                <Tr>
                                    <Th>ID</Th>
                                            ...
                                            <Tr
                                                ...
                                                <Td>
                                                    <EditReportsByAdminModal
                                                        ...
                                                        <button
                                                            className="bg-[#f6bb3b] hover:bg-[#f6ab3b] text-white font-bold py-2 px-4 rounded ml-2">
                                                            Edit
                                                        </button>
                                                    </EditReportsByAdminModal>
                                                </Td>
                    ...
                    <TableContainer className="min-h-[400px]">
                        <Heading className="text-center">Closed Reports</Heading>
                        <Table>
                            <Thead>
                                <Tr>
                                    <Th>ID</Th>
