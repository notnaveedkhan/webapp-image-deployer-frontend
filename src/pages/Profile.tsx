    ...
    return (
        <div className="min-h-screen flex flex-col mt-6 ">
            <div className="flex gap-2 w-[80%] mx-auto p-6 bg-white rounded-lg shadow-md">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 text-sm">
                            {user?.roles.map((role: any) => {
                                return (
                                    <Badge key={role?.id} colorScheme={"green"}>
                                        {role?.name}
                                    </Badge>
                                );
                            })}
                        ...
                        <div className="flex gap-3">
                            ...
                            <EditProfile userData={userData as UserResponse}>
                                <button className="border-blue-500 border text-blue-500 p-2 rounded-md mt-4">
                                    Edit Profile
                                </button>
                            </EditProfile>
                ...
                <div className="flex-1 flex gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-blue-500 flex gap-3">
                            Address :
                            <address className="text-black">{user.address}</address>
                        </p>
                    </div>
                </div>
            </div>
            <div className="flex flex-col gap-2 w-[80%] mx-auto p-6 bg-white rounded-lg shadow-md mt-3">
                <CardModal>
                    <button
                        className="border-blue-500 w-fit flex justify-center gap-3 items-center border border-dashed text-blue-500 p-2 rounded-md mt-4">
                        <AddIcon/>
                        Add Card
                    </button>
                </CardModal>
